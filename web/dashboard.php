...
<head>
  ...
  <style>
    ...
    .topbar .logo { color: var(--ink); margin: 0; font-size: 1.1rem; font-weight: 700; }
    .topbar .logo span { color: var(--ice-deep); font-weight: 400; }
    .topbar a { color: var(--ice-deep); text-decoration: none; font-weight: 600; font-size: 0.9rem; }
