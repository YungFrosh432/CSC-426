...
**Live login app:** https://yungfrosh.ifree.page/
...
```
.
├── calculator/        calc, Python Tkinter desktop app
│   ├── calc.py
│   └── README.md
└── web/             PHP login authentication app (hosted online)
    ├── index.html
    ├── style.css
    ├── script.js
    ├── login.php
